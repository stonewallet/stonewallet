...
class RegularTextStyle{
  ...
  static TextStyle regular15700(Color color){
    return TextStyle(fontSize: 15, color: color, fontWeight: FontWeight.w700,);
  }
  ...
  static TextStyle regular15400(Color color){
    return TextStyle(fontSize: 15, color: color, fontWeight: FontWeight.w400,);
  }
  static TextStyle regular15300(Color color){
    return TextStyle(fontSize: 15, color: color, fontWeight: FontWeight.w300,height: 0);
  }
...
class LargeTextStyle{
  ...
  static TextStyle large28600(Color color){
    return  TextStyle(fontSize: 28, color: color, fontWeight: FontWeight.w600,);
  }
  ...
  static TextStyle large40700(Color color){
    return  TextStyle(fontSize: 40, color: color, fontWeight: FontWeight.w700,);
  }
...
class LightTextStyle{
  ...
  static TextStyle light13300(Color color){
    return  TextStyle(fontSize: 13, color: color, fontWeight: FontWeight.w300, height: 0,);
  }
...
class NasalTextStyle{
  static TextStyle nasal(Color color){
    return TextStyle(fontFamily: "Nasalization",color: color,fontSize: 36,fontWeight: FontWeight.w300);
  }
}